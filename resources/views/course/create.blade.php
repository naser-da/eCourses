        ...
        <div class="col-sm-6">
            <form action="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="subtitle" id="subtitle" placeholder="Course subtitle" class="form-control">
                </div>
                
                <div class="form-group">
                    <label for="description">Description</label>
                    <input type="text" name="description" id="description" placeholder="Course description" class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="n_weeks" id="n_weeks" placeholder="Number of weeks" class="form-control">
                </div>
            </div>
